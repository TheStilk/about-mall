...
- **Команда:**
    ```bash
    git clone https://github.com/TheStilk/Journey.git
    ```
- **Что происходит:** Git скачивает весь проект со всей его историей изменений на ваш компьютер. Вместо `https://github.com/TheStilk/Journey.git` вы будете использовать ссылку на нужный вам проект.
...
- **Команда (только один раз для каждого проекта):**
    ```bash
    git remote add upstream https://github.com/TheStilk/Journey.git
    ```
